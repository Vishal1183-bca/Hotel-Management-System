...
class CustomerInfo extends JFrame
{
     JPanel left;
    JTable table;
    CustomerInfo()
    {
        ...
        JLabel text11 = new JLabel("Click Load-Data Button To Show All the Customer Details");
        text11.setFont(new Font("Sitka Text",Font.BOLD,30));
        text11.setBounds(550,30,900,40);
     ...
     btn2.setForeground(new Color(0,102,102));
        ...
        // Frame settings
        setTitle("All Customers Details.");
        setLayout(null);
        setSize(1950, 1100);
