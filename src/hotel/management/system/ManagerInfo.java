...
class ManagerInfo extends JFrame
{
    JPanel left;
    JTable table;
    ManagerInfo()
    {
        ...
        JLabel text11 = new JLabel("Click Load-Data Button To Show All Managers Details");
       ...
       table.getTableHeader().setForeground(Color.WHITE);
        ...
        btn1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Conn c = new Conn();
                String str = "SELECT * FROM employee where jobRole = 'Manager'";
                try {
